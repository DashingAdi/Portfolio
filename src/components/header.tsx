  ...
  return (
    <div>
      <header className="z-[999] relative">
        <div
          className="fixed flex mx-auto right-0 left-0 top-12 h-[3.25rem] w-[30rem] rounded-full border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
        >
